...
public class EbtCashBackPurchaseBuilder extends HpsBuilderAbstract<HpsFluentEbtService, HpsEbtAuthorization> {
    ...
    public EbtCashBackPurchaseBuilder withAllowDuplicates(boolean value) {
        this.allowDuplicates = value;
        return this;
    }
    public EbtCashBackPurchaseBuilder withAmount(BigDecimal value) {
        this.amount = value;
        return this;
    }
    ...
    public EbtCashBackPurchaseBuilder withCashBack(BigDecimal value) {
        this.cashBack = value;
        return this;
    }
    ...
    public EbtCashBackPurchaseBuilder withRequestMultiUseToken(boolean value) {
    ...
    public EbtCashBackPurchaseBuilder(HpsFluentEbtService service) { super(service); }

    public HpsEbtAuthorization execute() throws HpsException {
        super.execute();

        Element transaction = Et.element("EBTCashBackPurchase");
