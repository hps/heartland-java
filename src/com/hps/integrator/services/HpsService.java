...
public abstract class HpsService {

    private boolean enableLogging = false;
    protected PosRequestVer10Transaction transaction = null;
    protected Long clientTransactionId = Long.valueOf(0);
    protected IHpsServicesConfig servicesConfig;

    protected HpsService() throws HpsException {
        this.servicesConfig = new HpsConfiguration();
    }

    protected HpsService(IHpsServicesConfig config) throws HpsException {
        this.servicesConfig = (config == null) ? new HpsConfiguration() : config;
    }

    protected HpsService(IHpsServicesConfig config, boolean enableLogging) throws HpsException {
        this.servicesConfig = (config == null) ? new HpsConfiguration() : config;
