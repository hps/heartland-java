...
public class PosCreditTxnEditReqType extends AttributeContainer implements KvmSerializable {
    ...
    public PosCreditTxnEditReqType() {
    }

    public PosCreditTxnEditReqType(AttributeContainer inObj, ExtendedSoapSerializationEnvelope envelope) {
