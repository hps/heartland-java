...
public class GiftCardReversalReqBlock1Type extends AttributeContainer implements KvmSerializable {
    ...
    public GiftCardReversalReqBlock1Type() {
    }

    public GiftCardReversalReqBlock1Type(AttributeContainer inObj, ExtendedSoapSerializationEnvelope envelope) {
