...
public class PosAuthenticateRspType extends AttributeContainer implements KvmSerializable {

    public String CredentialToken;

    public PosAuthenticateRspType() {
    }

    public PosAuthenticateRspType(AttributeContainer inObj, ExtendedSoapSerializationEnvelope envelope) {
