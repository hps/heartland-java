...
public class PosGiftCardReplaceRspType extends AttributeContainer implements KvmSerializable {
    ...
    public PosGiftCardReplaceRspType() {
    }

    public PosGiftCardReplaceRspType(AttributeContainer inObj, ExtendedSoapSerializationEnvelope envelope) {
