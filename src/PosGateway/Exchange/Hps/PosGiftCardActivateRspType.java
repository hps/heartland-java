...
public class PosGiftCardActivateRspType extends AttributeContainer implements KvmSerializable {
    ...
    public PosGiftCardActivateRspType() {
    }

    public PosGiftCardActivateRspType(AttributeContainer inObj, ExtendedSoapSerializationEnvelope envelope) {
