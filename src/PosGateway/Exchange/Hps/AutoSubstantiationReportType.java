...
public class AutoSubstantiationReportType extends AttributeContainer implements KvmSerializable {

    public Enums.booleanType RealTimeSubstantiation = Enums.booleanType.N;
    ...
    public AutoSubstantiationReportType() {
    }

    public AutoSubstantiationReportType(AttributeContainer inObj, ExtendedSoapSerializationEnvelope envelope) {
