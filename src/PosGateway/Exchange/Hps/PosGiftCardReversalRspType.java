...
public class PosGiftCardReversalRspType extends AttributeContainer implements KvmSerializable {
    ...
    public PosGiftCardReversalRspType() {
    }

    public PosGiftCardReversalRspType(AttributeContainer inObj, ExtendedSoapSerializationEnvelope envelope) {
