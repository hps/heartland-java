...
public class PosGiftCardBalanceRspType extends AttributeContainer implements KvmSerializable {
    ...
    public PosGiftCardBalanceRspType() {
    }

    public PosGiftCardBalanceRspType(AttributeContainer inObj, ExtendedSoapSerializationEnvelope envelope) {
