...
public class PosCheckSaleReqType extends AttributeContainer implements KvmSerializable {

    public CheckSaleReqBlock1Type Block1;

    public PosCheckSaleReqType() {
    }
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info) {
        if (propertyIndex == 0) {
            info.type = CheckSaleReqBlock1Type.class;
            info.name = "Block1";
