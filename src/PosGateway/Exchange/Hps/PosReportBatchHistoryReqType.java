...
public class PosReportBatchHistoryReqType extends AttributeContainer implements KvmSerializable {
    ...
    public PosReportBatchHistoryReqType(AttributeContainer inObj, ExtendedSoapSerializationEnvelope envelope) {
