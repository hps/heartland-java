...
public class CashReturnReqBlock1Type extends AttributeContainer implements KvmSerializable {
    ...
    public CashReturnReqBlock1Type() {
    }

    public CashReturnReqBlock1Type(AttributeContainer inObj, ExtendedSoapSerializationEnvelope envelope) {
