...
public class EBTFSReturnReqBlock1Type extends AttributeContainer implements KvmSerializable {
    ...
    public EBTFSReturnReqBlock1Type() {
    }

    public EBTFSReturnReqBlock1Type(AttributeContainer inObj, ExtendedSoapSerializationEnvelope envelope) {
