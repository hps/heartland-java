...
public class EBTCashBenefitWithdrawalReqBlock1Type extends AttributeContainer implements KvmSerializable {
    ...
    public EBTCashBenefitWithdrawalReqBlock1Type() {
    }

    public EBTCashBenefitWithdrawalReqBlock1Type(AttributeContainer inObj, ExtendedSoapSerializationEnvelope envelope) {
