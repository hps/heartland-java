...
public class PosCreditVoidReqType extends AttributeContainer implements KvmSerializable {

    public Integer GatewayTxnId = 0;

    public PosCreditVoidReqType() {
    }

    public PosCreditVoidReqType(AttributeContainer inObj, ExtendedSoapSerializationEnvelope envelope) {
