...
public class PosCheckVoidRspType extends AttributeContainer implements KvmSerializable {
    ...
    public PosCheckVoidRspType() {
    }

    public PosCheckVoidRspType(AttributeContainer inObj, ExtendedSoapSerializationEnvelope envelope) {
