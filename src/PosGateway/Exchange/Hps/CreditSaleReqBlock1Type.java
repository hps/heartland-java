...
public class CreditSaleReqBlock1Type extends AttributeContainer implements KvmSerializable {
    ...
    public CreditSaleReqBlock1Type() {
    }

    public CreditSaleReqBlock1Type(AttributeContainer inObj, ExtendedSoapSerializationEnvelope envelope) {
        ...
        if (soapObject.hasProperty("OrigTxnRefData")) {
            Object j = soapObject.getProperty("OrigTxnRefData");
    ...
    public Object getProperty(int propertyIndex) {
        ...
        if (propertyIndex == 13) {
            return OrigTxnRefData != null ? OrigTxnRefData : SoapPrimitive.NullSkip;
        }
        if (propertyIndex == 14) {
