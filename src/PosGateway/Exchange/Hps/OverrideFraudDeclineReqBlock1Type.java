...
public class OverrideFraudDeclineReqBlock1Type extends AttributeContainer implements KvmSerializable {
    ...
    public OverrideFraudDeclineReqBlock1Type() {
    }

    public OverrideFraudDeclineReqBlock1Type(AttributeContainer inObj, ExtendedSoapSerializationEnvelope envelope) {
