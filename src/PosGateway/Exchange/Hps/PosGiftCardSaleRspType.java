...
public class PosGiftCardSaleRspType extends AttributeContainer implements KvmSerializable {
    ...
    public PosGiftCardSaleRspType(AttributeContainer inObj, ExtendedSoapSerializationEnvelope envelope) {
