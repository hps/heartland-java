...
public class PrePaidAddValueReqBlock1Type extends AttributeContainer implements KvmSerializable {
    ...
    public PrePaidAddValueReqBlock1Type() {
    }

    public PrePaidAddValueReqBlock1Type(AttributeContainer inObj, ExtendedSoapSerializationEnvelope envelope) {
