...
public class PosImpersonateRspTypeUser extends AttributeContainer implements KvmSerializable {
    ...
    public PosImpersonateRspTypeUser(AttributeContainer inObj, ExtendedSoapSerializationEnvelope envelope) {
