...
public class EBTFSVoucherReqBlock1Type extends AttributeContainer implements KvmSerializable {
    ...
    public EBTFSVoucherReqBlock1Type(AttributeContainer inObj, ExtendedSoapSerializationEnvelope envelope) {
        ...
        if (soapObject.hasProperty("ExprDate")) {
            Object obj = soapObject.getProperty("ExprDate");
            if (obj != null && obj.getClass().equals(SoapPrimitive.class)) {
                SoapPrimitive j = (SoapPrimitive) obj;
                if (j.toString() != null) {
                    this.ExprDate = j.toString();
                }
            } else if (obj != null && obj instanceof String) {
                this.ExprDate = (String) obj;
            }
        }
        if (soapObject.hasProperty("ElectronicVoucherSerialNbr")) {
            Object obj = soapObject.getProperty("ElectronicVoucherSerialNbr");
            if (obj != null && obj.getClass().equals(SoapPrimitive.class)) {
                SoapPrimitive j = (SoapPrimitive) obj;
                if (j.toString() != null) {
                    this.ElectronicVoucherSerialNbr = j.toString();
                }
            } else if (obj != null && obj instanceof String) {
                this.ElectronicVoucherSerialNbr = (String) obj;
            }
        }
        if (soapObject.hasProperty("VoucherApprovalCd")) {
            Object obj = soapObject.getProperty("VoucherApprovalCd");
            if (obj != null && obj.getClass().equals(SoapPrimitive.class)) {
                SoapPrimitive j = (SoapPrimitive) obj;
                if (j.toString() != null) {
                    this.VoucherApprovalCd = j.toString();
                }
            } else if (obj != null && obj instanceof String) {
                this.VoucherApprovalCd = (String) obj;
            }
        }
        if (soapObject.hasProperty("PrimaryAcctNbr")) {
            Object obj = soapObject.getProperty("PrimaryAcctNbr");
            if (obj != null && obj.getClass().equals(SoapPrimitive.class)) {
                SoapPrimitive j = (SoapPrimitive) obj;
                if (j.toString() != null) {
                    this.PrimaryAcctNbr = j.toString();
                }
            } else if (obj != null && obj instanceof String) {
                this.PrimaryAcctNbr = (String) obj;
            }
        }
    ...
    public Object getProperty(int propertyIndex) {
        ...
        if (propertyIndex == 5) {
            return ExprDate != null ? ExprDate : SoapPrimitive.NullSkip;
        }
        if (propertyIndex == 6) {
            return ElectronicVoucherSerialNbr != null ? ElectronicVoucherSerialNbr : SoapPrimitive.NullSkip;
        }
        if (propertyIndex == 7) {
            return VoucherApprovalCd != null ? VoucherApprovalCd : SoapPrimitive.NullSkip;
        }
        if (propertyIndex == 8) {
            return PrimaryAcctNbr != null ? PrimaryAcctNbr : SoapPrimitive.NullSkip;
        }
        return null;
    }
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info) {
        ...
        if (propertyIndex == 6) {
            info.type = PropertyInfo.STRING_CLASS;
            info.name = "ElectronicVoucherSerialNbr";
            info.namespace = "http://Hps.Exchange.PosGateway";
        }
        if (propertyIndex == 7) {
            info.type = PropertyInfo.STRING_CLASS;
            info.name = "VoucherApprovalCd";
            info.namespace = "http://Hps.Exchange.PosGateway";
        }
        if (propertyIndex == 8) {
            info.type = PropertyInfo.STRING_CLASS;
            info.name = "PrimaryAcctNbr";
            info.namespace = "http://Hps.Exchange.PosGateway";
        }
    }
