...
public class CreditOfflineAuthReqBlock1Type extends AttributeContainer implements KvmSerializable {
    ...
    public CreditOfflineAuthReqBlock1Type() {
    }

    public CreditOfflineAuthReqBlock1Type(AttributeContainer inObj, ExtendedSoapSerializationEnvelope envelope) {
