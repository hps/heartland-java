...
public class CardDataTypeManualEntry extends AttributeContainer implements KvmSerializable {
    ...
    public CardDataTypeManualEntry(AttributeContainer inObj, ExtendedSoapSerializationEnvelope envelope) {
