...
public class GiftCardActivateReqBlock1Type extends AttributeContainer implements KvmSerializable {
    ...
    public GiftCardActivateReqBlock1Type() {
    }

    public GiftCardActivateReqBlock1Type(AttributeContainer inObj, ExtendedSoapSerializationEnvelope envelope) {
