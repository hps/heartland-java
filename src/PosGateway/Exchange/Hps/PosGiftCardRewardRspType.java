...
public class PosGiftCardRewardRspType extends AttributeContainer implements KvmSerializable {
    ...
    public PosGiftCardRewardRspType() {
    }

    public PosGiftCardRewardRspType(AttributeContainer inObj, ExtendedSoapSerializationEnvelope envelope) {
