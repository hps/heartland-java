...
public class PosGetUserSettingsRspType extends AttributeContainer implements KvmSerializable {

    public ArrayList<MidRspType> MIDS = new ArrayList<MidRspType>();

    public PosGetUserSettingsRspTypeUser User;

    public PosGetUserSettingsRspType() {
    }

    public PosGetUserSettingsRspType(AttributeContainer inObj, ExtendedSoapSerializationEnvelope envelope) {
        ...
        if (soapObject.hasProperty("User")) {
            ...
            this.User = (PosGetUserSettingsRspTypeUser) envelope.get(j, PosGetUserSettingsRspTypeUser.class);
        }
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info) {
        if (propertyIndex == 0) {
            info.type = PosGetUserSettingsRspTypeUser.class;
            info.name = "User";
