...
public class GiftCardDeactivateReqBlock1Type extends AttributeContainer implements KvmSerializable {

    public GiftCardDataType CardData;

    public GiftCardDeactivateReqBlock1Type() {
    }

    public GiftCardDeactivateReqBlock1Type(AttributeContainer inObj, ExtendedSoapSerializationEnvelope envelope) {
