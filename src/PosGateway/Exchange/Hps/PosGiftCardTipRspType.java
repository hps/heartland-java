...
public class PosGiftCardTipRspType extends AttributeContainer implements KvmSerializable {
    ...
    public BigDecimal SplitTenderCardAmt;

    public BigDecimal SplitTenderBalanceDueAmt;
    ...
    public PosGiftCardTipRspType() {
    }

    public PosGiftCardTipRspType(AttributeContainer inObj, ExtendedSoapSerializationEnvelope envelope) {
    ...
    public Object getProperty(int propertyIndex) {
        ...
        if (propertyIndex == 4) {
            return SplitTenderCardAmt != null ? SplitTenderCardAmt.toString() : SoapPrimitive.NullSkip;
        }
        if (propertyIndex == 5) {
            return SplitTenderBalanceDueAmt != null ? SplitTenderBalanceDueAmt.toString() : SoapPrimitive.NullSkip;
        }
        if (propertyIndex == 6) {
            return PointsBalanceAmt != null ? PointsBalanceAmt.toString() : SoapPrimitive.NullSkip;
        }
        if (propertyIndex == 7) {
            return Rewards != null ? Rewards : SoapPrimitive.NullSkip;
        }
        if (propertyIndex == 8) {
    ...
    public void getPropertyInfo(int propertyIndex, @SuppressWarnings("rawtypes") Hashtable arg1, PropertyInfo info) {
        ...
        if (propertyIndex == 4) {
            info.type = PropertyInfo.STRING_CLASS;
            info.name = "SplitTenderCardAmt";
            info.namespace = "http://Hps.Exchange.PosGateway";
        }
        if (propertyIndex == 5) {
            info.type = PropertyInfo.STRING_CLASS;
            info.name = "SplitTenderBalanceDueAmt";
            info.namespace = "http://Hps.Exchange.PosGateway";
        }
        if (propertyIndex == 6) {
            info.type = PropertyInfo.STRING_CLASS;
