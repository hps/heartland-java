...
public class GiftCardRewardReqBlock1Type extends AttributeContainer implements KvmSerializable {
    ...
    public GiftCardRewardReqBlock1Type(AttributeContainer inObj, ExtendedSoapSerializationEnvelope envelope) {
