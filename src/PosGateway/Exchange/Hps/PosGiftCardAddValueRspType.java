...
public class PosGiftCardAddValueRspType extends AttributeContainer implements KvmSerializable {
    ...
    public PosGiftCardAddValueRspType() {
    }

    public PosGiftCardAddValueRspType(AttributeContainer inObj, ExtendedSoapSerializationEnvelope envelope) {
