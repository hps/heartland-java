...
public class PosGetUserDeviceSettingsReqType extends AttributeContainer implements KvmSerializable {

    public String MerchNbr;

    public Integer DeviceId = 0;

    public PosGetUserDeviceSettingsReqType() {
    }

    public PosGetUserDeviceSettingsReqType(AttributeContainer inObj, ExtendedSoapSerializationEnvelope envelope) {
