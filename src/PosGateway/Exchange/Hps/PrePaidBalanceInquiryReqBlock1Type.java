...
public class PrePaidBalanceInquiryReqBlock1Type extends AttributeContainer implements KvmSerializable {

    public CardDataType CardData;

    public CardHolderDataType CardHolderData;

    public PrePaidBalanceInquiryReqBlock1Type() {
    }

    public PrePaidBalanceInquiryReqBlock1Type(AttributeContainer inObj, ExtendedSoapSerializationEnvelope envelope) {
